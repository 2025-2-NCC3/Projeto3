...
public final class ItemOrderProductBinding implements ViewBinding {
  ...
  private ItemOrderProductBinding(@NonNull CardView rootView, @NonNull TextView textProductName,
  ...
  public static ItemOrderProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemOrderProductBinding((CardView) rootView, textProductName, textQuantity,
          textSubtotal, textUnitPrice);
    }
